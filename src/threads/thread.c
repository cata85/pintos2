...
// minimum value of fd since 0 1 are not valid
#define MIN_FD 2
...
/* check if specified thread is alive. It loops through
   all of the processes in the all_list and if the pid is
   found then it is alive, else it returns false */
...
/* Releases all locks that the current thread still holds */
